...
import { FIRST_WEEK_DAY, LAST_WEEK_DAY, MAX_GUEST, MAX_LAT_VALUE, MAX_LON_VALUE, MAX_PRICE, MAX_ROOM, MIN_GUEST, MIN_LAT_VALUE, MIN_LON_VALUE, MIN_PRICE, MIN_ROOM } from './const.js';
...
export class TSVOfferGenerator implements OfferGenerator {
  ...
  generate(): string {
    ...
    return [title, description, postDate, city, preview, images, isPremium, houseType, room, guest, price, conveniences, name, email, avatar, type, commentsCount, coords].join('\t');
  }
}
